...
- Added `LineReader.TryRead` extension overloads for `FixedArray2` through `FixedArray5`, including custom parse-policy readers.
...
[0.1.1]: https://github.com/dlakek/ferry-kit/releases/tag/v0.1.1
